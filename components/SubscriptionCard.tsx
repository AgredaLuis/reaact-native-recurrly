...
const SubscriptionCard = ({ name, price, currency, icon, billing, color, renewalDate, plan, category, expanded, onPress, paymentMethod, startDate, status }: SubscriptionCardProps) => {
    return (
